...
function Card({ service }) {
  return (
    <div className="w-full h-[400px] hover:scale-[1.01] cursor-pointer duration-300 bg-[#1F1D2B] shadow-[#2f2c3f] shadow-2xl border-[0.5px] border-gray-400 rounded-lg m-2">
      <img
        src={service.imgLink}
        alt={service.name}
      ...
      <div className="p-2 flex flex-col justify-between h-[180px] ">
        ...
        <p className="px-2 text-green-400 text-lg font-semibold">{service.price}</p>
